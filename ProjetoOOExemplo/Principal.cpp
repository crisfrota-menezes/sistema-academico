...
Principal::Principal(int dia, int mes, int ano) : // "geradores" de identifica��o
												  cont_idAluno(0),
												  cont_idDisc(0),
												  cont_idDepart(0),
...
void Principal::InicializaDepartamentos()
{
	...
	EletronicaUTFPR.setNome("Eletrônica UTFPR");
	MatematicaUTFPR.setNome("Matemática UTFPR");
	FisicaUTFPR.setNome("Física UTFPR");
	MatematicaPrinceton.setNome("Matemática Princeton");
	FisicaPrinceton.setNome("Física Princeton");
	MatematicaCambridge.setNome("Matemática Cambridge");
	FisicaCambridge.setNome("Física Cambridge");
...
{
	Computacao1_2006.setNome("Computação I 2006");
	Introd_Alg_2007.setNome("Introdução de Algoritmos de Programação 2007");
